...
const Main = () => {
  return (
    ...
    <section className={classes.tasks}>
      ...
      <p><s>Fazer o carrossel dos cards abaixo</s> Deu muito ruim, erro de hooks</p>
      ...
      <p>
        Criar a interface(uma pagina só para alimentar o DB), com C.R.U.D.
        das infos usadas no portfólio. (((Doing)))
      </p>
      ...
      <p>
        ...
        card terá suas próprias cores de borda, tipo neon, fazendo jús ao
        seu brasão.
      </p>
      <p>
        Aprender como fazer para que ao clicar no card, ele suba em z-index
        para frente, tomando toda a tela, e colocar alguns exemplos em
        formado de imagens, talvez em carrossel, mostrando os principais
        comandos/tags e seus usos.
      </p>
      <p>
      ...
      <p>
        <s>
          Fazer o card com as infos da tec + img + link para a pagina
          oficial
        </s>
      </p>
    </section>
